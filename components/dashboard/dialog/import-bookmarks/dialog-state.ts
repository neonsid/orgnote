...
export type ImportDialogAction =
  ...
  | { type: "setDuplicateAlertOpen"; open: boolean }
...
export const INITIAL_IMPORT_DIALOG_STATE: ImportDialogState = {
  parsedItems: null,
  chromeFolderKeys: [],
  loadedFileLabel: "",
...
export function importDialogReducer(
  ...
  switch (action.type) {
    case "reset":
      return INITIAL_IMPORT_DIALOG_STATE;
    case "fileParsed": {
    ...
    case "setDuplicateAlertOpen":
      return { ...state, duplicateAlertOpen: action.open };
    case "setImporting":
